@echo off
rem ==============================================================
rem  Cuts the top 5 moments as 9:16 vertical clips at 1.25x
rem  speed, for Shorts. The game screen is never cropped;
rem  the background is a blurred fill. Voice pitch is kept
rem  (atempo, not resampling).
rem
...
echo.
python -m kirinuki cut "%VIDEO%" --top 5 --vertical --speed 1.25
